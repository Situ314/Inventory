        ...
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            ...
                            <form class="form-auth-small" method="POST" action="{{ route('login') }}">
                                ...
                                <a type="button" href="/register" class="btn btn-primary btn-lg">REGISTER</a>
                    ...
                    <div class="right")>
                        <div class="overlay" style="background-image: url('https://www.ascm.org/globalassets/ascm_website_assets/img/landing/im-01.jpg');">
                    </div>
